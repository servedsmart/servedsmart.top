...
Some images have been downloaded from [Reshot](https://www.reshot.com). Those images are not licensed as MIT. The terms applicable to those files are available [here](https://github.com/servedsmart/servedsmart.top/blob/nightstore/graphics/projects/logo/reshot/2025-04-30-reshot-license.pdf) and [here](https://github.com/servedsmart/servedsmart.top/blob/nightstore/graphics/projects/logo/reshot/2025-04-30-reshot-user-terms.pdf).
